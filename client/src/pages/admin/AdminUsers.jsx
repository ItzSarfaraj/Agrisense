...
const AdminUsers = () => {
  ...
  return (
    <DashboardLayout>
      {/* No extra p-8 here — DashboardLayout already supplies responsive page padding */}
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 -m-4 md:-m-6 p-4 md:p-6">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="max-w-md bg-white rounded-2xl shadow-sm border border-green-100 px-1">

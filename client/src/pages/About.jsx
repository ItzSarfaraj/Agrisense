      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          <div className="bg-white rounded-3xl shadow-md p-6 text-center">
            <h3 className="text-4xl font-bold text-green-600">29+</h3>
            <p className="text-gray-500 mt-2">Crop Guides</p>
          </div>

          <div className="bg-white rounded-3xl shadow-md p-6 text-center">
            <h3 className="text-4xl font-bold text-blue-600">100%</h3>
            <p className="text-gray-500 mt-2">Data Driven</p>
          </div>

          <div className="bg-white rounded-3xl shadow-md p-6 text-center">
            <h3 className="text-4xl font-bold text-orange-600">24/7</h3>
            <p className="text-gray-500 mt-2">Accessibility</p>
          </div>

          <div className="bg-white rounded-3xl shadow-md p-6 text-center">
            <h3 className="text-4xl font-bold text-purple-600">Smart</h3>
        ...
        <div>
          ...
          <h2 className="text-3xl font-bold mt-2 mb-6">Platform Features</h2>
        ...
        <div className="bg-white rounded-3xl shadow-md p-8">
          ...
          <h2 className="text-3xl font-bold mt-2 mb-8">How AgriSense Works</h2>
